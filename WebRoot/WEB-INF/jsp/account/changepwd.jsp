...
<html>
  <head>
	...
	<!--form-->
		<div class="resetPSW">
			<form class="formRP" action="Account/changepwd.html" method="post" id="changepwd">
				<div class="formList">
				<label>原密码</label>
				<input type="password" placeholder="输入原密码" name="old" id="old"/></div>
				<div class="formList">
				<label>新密码</label>
				<input type="password" placeholder="密码由英文和数字组成" name="new1" id="new1"/></div>
				<div class="formList">
				<label>确认密码</label>
