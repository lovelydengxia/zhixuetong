...
<html>
	...
	<style type="text/css">
		.intr-list{padding: 10px 15px;margin: 5px 15px;list-style: none;}
		.intr-list p{line-height: 1.8em; font-size: 0.9em;}
		.intr-list h4{margin-bottom: 10px;}
	</style>
...
<body>
		...
		<header class="mui-bar mui-bar-nav" >
			<a class="mui-icon " href="<%=basePath%>About/index.html"><img class="back" src="<%=basePath%>img/back.png" /></a>
			<h1 id="title" class="mui-title">免责协议</h1>
		</header>
		<div class="mui-content">
		    <ul class="intr-list">
		    	...
		    	<li>
		    		<p>2、APP手机APP转载的内容并不代表APP手机APP之意见及观点，也不意味着本网赞同其观点或证实其内容的真实性。</p>
		    	</li>
		    	<li>
		    		<p>3、APP手机APP转载的文字、图片、音视频等资料均由本APP用户提供，其真实性、准确性和合法性由信息发布人负责。APP手机APP不提供任何保证，并不承担任何法律责任。	</p>
		    	</li>
		    	<li>
