	...
	<!------header------->
		...
		<div class="bannerP">基本信息</div>
			<div class="mui-input-row">
		        <label>昵称：</label>
		        <input type="text" class="mui-input-clear" id="nickname" name="nickname" value="${teacher.nickname }"/>
		    </div>
		    <div class=" mui-input-row">
		        <label>名称：</label>
		        <input type="text" class="mui-input-clear" id="name" name="name" value=${teacher.name } />
		    </div>
		    <div class="mui-input-row">
		        <label>性别：</label>
		    ...
		    <div class="mui-input-row">
		    	<label>出生日期：</label>
		        <input type="text" class="mui-input-clear times" data-options='{"type":"date"}'  name="csrq" id="result" value="${teacher.csrq }" />
		    ...
		    <div class="mui-input-row">
		        <label>籍贯：</label>
		        <input type="text" class="mui-input-clear" id="jg" name="jg" value="${teacher.jg }" >
		    </div>
		    <div class="bannerP">其它</div>
		    <div class="mui-input-row">
		        <label>手机：</label>
		        <input type="text" class="mui-input-clear" id="phone" name="phone" value="${teacher.phone }"/>
		    </div>
		    <div class="mui-input-row">
		        <label>QQ：</label>
		        <input type="text" class="mui-input-clear" id="qq" name="qq" value="${teacher.qq }" >
		    </div>
		    <div class="mui-input-row">
		        <label>邮箱：</label>
		        <input type="text" class="mui-input-clear" id="email" name="email" value="${teacher.email }" >
		    </div>
...
<script type="text/javascript">
	$("#confirmBtn").click(function(){
		...
		var email = $("#email").val();
		/* var btnArray = ['否', '是']; */
		if(name == null || name == "" || nickname == null || nickname == "" || sex == null || sex == "" || phone == null || phone == "" || csrq == null || csrq == "" || jg == null || jg == "" || qq == null || qq == "" || email == null || email == "" ){
			var btnArray = ['确定'];
