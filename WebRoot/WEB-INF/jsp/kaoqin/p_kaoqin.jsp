...
<html>
	...
	<!--下拉刷新容器-->
		...
		<script>
			 ...
			 */
			 var  pageSize=0;
			 var xh = ${sessionScope.user.xgh};
			function pullupRefresh() {
				setTimeout(function() {					
					pageSize+=5;
					mui.ajax("<%=basePath%>kaoqin/ajaxlist.html?pageSize="+pageSize+"&gh="+xh,{
					...
					success:function(list){
						...
						li.innerHTML = '<a ><div class="detial logBox"  did='+list.data[i].id+' >'
						+'<div class="logList" >'
							+'<div class="detial logPic" did='+list.data[i].id+'><img width="50px" height="50px" src="<%=basePath%>kaoqin/'+list.data[i].images+'" /> </div>'
