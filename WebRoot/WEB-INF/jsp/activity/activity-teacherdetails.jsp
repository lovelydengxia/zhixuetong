...
<base href="<%=basePath%>">
	...
	<body>
		...
		<div class="mui-content">
		    <div>
		<img src="<%=basePath%>img/u37.png" width="100%" /> 
		    </div>
		    <div class="text-cont"> 
		    <input type="hidden" id="msg" name="activityStatus" value="${article.activityStatus}" />
		    ...
		    <div class="p-x-15 m-top-25">
				<a id="a1" class="mui-btn mui-btn-block mui-btn-success" href="<%=basePath%>article/getPayDetails.html?id=${article.id}&userid=${user.id}">我要报名</a>
			</div>
		</div>
