...
<body>
	<!------header------->
		...
		<form action="<%=basePath%>article/getSuccess.html">
			<div class="mui-content m-top-25 text-center">
		        ...
		        <ul class="mui-table-view m-top-5">
		            <li class="mui-table-view-cell">
		                ...
		                <input class="center" type="password" name = pwd/>
		            </li>
		        ...
		        <div class="p-x-15 m-top-25">
					<button class="mui-btn mui-btn-block mui-btn-success" type="submit">立即支付</button>
				</div>
			</div>
		</form> 
		</div>
